...
at=AnchoredText("RMSE = "+"{:.2f}".format(round(rmse,2))+"\nPCC = "+"{:.2f}".format(round(rho_corr,2)),prop=dict(size=10),frameon=True,loc=4)
at.patch.set_boxstyle("round, pad=0.,rounding_size=0.2")
ax[0].add_artist(at)
...
series_0.set_clim(0.5,3.5)
series_1.set_clim(0.5,3.5)
series_2.set_clim(0.5,3.5)
...
ax[3].plot(np.linspace(0.5,3.5,10),np.linspace(0.5,3.5,10),color="black")
...
ax[4].plot(np.linspace(0.5,3.5,10),np.linspace(0.5,3.5,10),color="black")
...
ax[5].plot(np.linspace(0.5,3.5,10),np.linspace(0.5,3.5,10),color="black")
...
ax[3].set_yticks(np.linspace(0.5,3.5,6))
ax[3].set_xticks(np.linspace(0.5,2.9,5))
ax[3].set_ylabel(r"$\sigma_\mathrm{est}$")
ax[3].set_xlabel(r"$\sigma$")
ax[4].set_yticks([])
ax[4].set_xlabel(r"$\sigma$")
ax[4].set_xticks(np.linspace(0.5,2.9,5))
ax[5].set_yticks([])
ax[5].set_xlabel(r"$\sigma$")
ax[5].set_xticks(np.linspace(0.5,3.5,6))
...
fig_1.colorbar(series_2, cax=cbar_ax,ticks=np.linspace(0.7,3.2,6),label=r"$\sigma$")

pos=ax[5].get_position()
cbar_ax = fig_1.add_axes([0.90, pos.y0, 0.02, pos.y1-pos.y0])
fig_1.colorbar(series_5, cax=cbar_ax,ticks=np.linspace(0,1,6),label=r"$H$")

fig_1.savefig("uncertainties.pdf",dpi=150)

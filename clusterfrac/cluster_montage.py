...
for i in range(1,len(ax)):
    ...
    A=scalar_grf(gridsize,2.+2.*0.7)
    A.normalise(1.4,True)
    A.com_shift()
...
at=AnchoredText(r"$\rho$ Oph.",prop=dict(size=10),frameon=True,loc=2)
at.patch.set_boxstyle("round, pad=0.,rounding_size=0.2")
ax[0].add_artist(at)

at=AnchoredText(r"$H=0.7, \sigma=1.4$",prop=dict(size=10),frameon=True,loc=2)
at.patch.set_boxstyle("round, pad=0.,rounding_size=0.2")
ax[1].add_artist(at)
...
at=AnchoredText(r"$H=0.3, \sigma=1.3$",prop=dict(size=10),frameon=True,loc=2)
at.patch.set_boxstyle("round, pad=0.,rounding_size=0.2")
ax[1].add_artist(at)

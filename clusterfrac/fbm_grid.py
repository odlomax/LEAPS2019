...
at=AnchoredText(r"$H=1.0, \sigma=3.0$",prop=dict(size=10),frameon=True,loc=2)
at.patch.set_boxstyle("round, pad=0.,rounding_size=0.2")
ax[2].add_artist(at)
...
at=AnchoredText(r"$H=0.5, \sigma=3.0$",prop=dict(size=10),frameon=True,loc=2)
at.patch.set_boxstyle("round, pad=0.,rounding_size=0.2")
ax[5].add_artist(at)
...
at=AnchoredText(r"$H=0.0, \sigma=3.0$",prop=dict(size=10),frameon=True,loc=2)
at.patch.set_boxstyle("round, pad=0.,rounding_size=0.2")
ax[8].add_artist(at)

fig_1.tight_layout()
fig_1.subplots_adjust(hspace=0,wspace=0)
fig_1.savefig("fbm.pdf",dpi=150)
...
fig_2.savefig("cluster.pdf",dpi=150)
